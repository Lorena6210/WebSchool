...
import { Grid, Card, Box, Typography, LinearProgress, Badge } from "@mui/material";
import { FaBookOpen } from "react-icons/fa";
import { Disciplina } from "@/types/Turma";

interface DisciplinasListProps {
  disciplinas: Disciplina[];
}

const DisciplinasList: React.FC<DisciplinasListProps> = ({ disciplinas }) => (
    ...
    {disciplinas.map((disciplina, i) => (
      <Grid item xs={12} sm={6} md={4} key={disciplina.id}>
        ...
        >
          ...
          {disciplina.progresso !== undefined && (
            <Box sx={{ mb: "16px" }}>
              <LinearProgress
                variant="determinate"
